...
private let reuseIdentifier = "TrainingDetailHeader"
private let reuseIdentifier1 = "YTVideoCell"
class TrainingDetailVC: UICollectionViewController,UICollectionViewDelegateFlowLayout{
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! TrainingDetailHeader
            cell.data = plan
