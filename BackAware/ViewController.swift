...
//let BLE_Heart_Rate_Service_CBUUID = CBUUID(string: "0x1801")
//
//// MARK: - Core Bluetooth characteristic IDs
//let BLE_Heart_Rate_Measurement_Characteristic_CBUUID = CBUUID(string: "00002902-0000-1000-8000-00805f9b34fb")
